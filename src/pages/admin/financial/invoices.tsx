      ...
      const mockInvoices: Invoice[] = [
        {
          ...
          items: [
            {
              id: 'item_1',
              description: 'إيجار شهر يناير 2025 - فيلا الخوير',
              quantity: 1,
              unitPrice: 500,
              taxRate: 5,
              discountRate: 0,
        ...
        },
        {
          ...
          issuerId: 'landlord_1',
          customerId: 'tenant_2',
          customerName: 'فاطمة علي الشنفري',
          ...
          items: [
            {
              id: 'item_2',
              description: 'صيانة دورية - شقة 205',
              quantity: 1,
              unitPrice: 150,
              taxRate: 5,
              discountRate: 10,
        ...
        },
        {
          ...
          issuerId: 'admin_1',
          customerId: 'user_3',
          customerName: 'سالم بن راشد الغافري',
          customerEmail: 'salim@realestate.com',
          ...
          items: [
            {
              id: 'item_3',
              description: 'اشتراك الخطة المميزة - سنوي',
              quantity: 1,
              unitPrice: 1200,
              taxRate: 5,
              discountRate: 0,
