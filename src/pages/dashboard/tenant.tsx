...
export default function Page() {
  const features = ["عرض وإدارة عقد/عقود الإيجار", "دفع الإيجارات والفواتير", "طلبات الصيانة والتذاكر", "إشعارات ومراسلات"] as string[];
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl md:text-3xl font-bold">مستأجر فردي</h1>
