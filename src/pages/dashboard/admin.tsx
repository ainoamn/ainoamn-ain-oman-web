...
export default function Page() {
  const features = ["Feature Flags/الخصائص", "الترجمات والعملات", "التكاملات والبوابات", "مراقبة النظام"] as string[];
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl md:text-3xl font-bold">مدير النظام</h1>
