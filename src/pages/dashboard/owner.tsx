...
const OwnerDashboard: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>لوحة مالك العقار | Ain Oman</title>
      </Head>

      <div className="min-h-screen bg-gray-50">
        <header className="bg-white shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <h1 className="text-2xl font-bold text-gray-900">لوحة مالك العقار</h1>
              ...
              >
                ...
                {rentals.length === 0 && (
                  <div className="text-center py-12">
                    ...
                    <p className="mt-1 text-sm text-gray-500">عندما يحجز أحد عقاراتك، ستظهر العقود هنا.</p>
                  </div>
                )}
              </motion.div>
            )}
...
function getStateLabel(state: string): string {
  const states: Record<string, string> = {
    ...
    "accountant_checked": "تم مراجعة المحاسب",
    "admin_approved": "موافقة المشرف النهائية",
