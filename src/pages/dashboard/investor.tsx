...
export default function Page() {
  const features = ["إدارة المحافظ والأصول", "اكتتابات واستثمارات جزئية", "توزيعات أرباح وتقارير", "مخاطر وتنبيهات"] as string[];
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl md:text-3xl font-bold">مستثمر/REIT/Fractional</h1>
        <Link href="/dashboard" className="text-teal-700 hover:underline">رجوع</Link>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
        <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 p-5">
          ...
          <div className="mt-3 text-sm">
            <Link href="/admin/tasks" className="px-3 py-2 rounded-xl border inline-block">فتح لوحة المهام</Link>
          </div>
        </div>
        <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 p-5">
