...
export default function Page() {
  const features = ["إدارة وحدات متعددة", "صلاحيات لموظفين فرعيين", "تقارير مجمّعة", "تكامل فواتير ودفع"] as string[];
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl md:text-3xl font-bold">مستأجر شركة</h1>
