...
const POSTS: Post[] = [
  {"id":"HOA-001","title":" ‰»ÌÂ ’Ì«‰… «·„’«⁄œ","body":"”Ì „ ≈Ã—«¡ ’Ì«‰… ÌÊ„ «·Ã„⁄….","date":"2025-08-12"},
  {"id":"HOA-002","title":" –ﬂÌ— —”Ê„ «·Œœ„« ","body":"Ì—ÃÏ ”œ«œ «·—”Ê„ ﬁ»· ‰Â«Ì… «·‘Â—.","date":"2025-08-20"},
];
const MEETINGS: Meeting[] = [
  {"id":"M-001","title":"«Ã „«⁄ «·Ã„⁄Ì… «·⁄„Ê„Ì…","date":"2025-09-01 18:00","location":"ﬁ«⁄… «·«Ã „«⁄«  - «·„»‰Ï A"},
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid gap-6 lg:grid-cols-3">
        ...
        <aside className="grid gap-4">
          <div className="rounded-2xl border bg-white p-4">
            <h4 className="font-semibold text-slate-900">«·«Ã „«⁄«  «·ﬁ«œ„…</h4>
    ...
    export default function Page() {
      ...
      return (
        <main dir={dir} className="min-h-screen bg-slate-50 flex flex-col">
          <Head><title>Ã„⁄Ì… «·„·«ﬂ | Ain Oman</title></Head>
