// src/pages/properties/index.tsx - ’›Õ… «·⁄ﬁ«—«  «·„Õ”¯‰… „⁄ AI
...
export default function PropertiesPage() {
  ...
  const loadAIRecommendations = async () => {
    // „Õ«ﬂ«… AI recommendations
    setAiRecommendations([
      { icon: '??', title: '«·√ﬂÀ— ÿ·»«', desc: '›·· ›Ì «·„Ê«·Õ', color: 'red' },
      { icon: '??', title: '”⁄— „‰«”»', desc: '‘ﬁﬁ  Õ  50,000', color: 'green' },
      { icon: '?', title: ' ﬁÌÌ„ ⁄«·Ì', desc: '⁄ﬁ«—«  5 ‰ÃÊ„', color: 'yellow' }
    ]);
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-3xl shadow-2xl p-8 mb-8 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h1 className="text-4xl font-bold">?? «” ﬂ‘› «·⁄ﬁ«—« </h1>
                  <p className="text-blue-100 text-lg">„œ⁄Ê„ »«·–ﬂ«¡ «·«’ÿ‰«⁄Ì ï {properties.length} ⁄ﬁ«— „ «Õ</p>
        </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                ...
                >
                  <option value="newest">«·√ÕœÀ</option>
                  <option value="price-low">«·”⁄—: „‰ «·√ﬁ·</option>
                  <option value="price-high">«·”⁄—: „‰ «·√⁄·Ï</option>
                  <option value="rating">«·√⁄·Ï  ﬁÌÌ„«</option>
                  </select>
            ...
            {showFilters && (
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 pt-4 border-t border-gray-200 animate-fade-in">
                ...
                >
                  ...
                  <option value="sale">··»Ì⁄</option>
                  <option value="rent">··≈ÌÃ«—</option>
                  <option value="investment">··«” À„«—</option>
                </select>
                ...
                <select
                  ...
                  className="px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-blue-500"
                >
                  <option value="all">ﬂ· «·„Õ«›Ÿ« </option>
                  <option value="muscat">„”ﬁÿ</option>
                  <option value="dhofar">Ÿ›«—</option>
                  <option value="dakhliyah">«·œ«Œ·Ì…</option>
                </select>
          ...
          {trendingProperties.length > 0 && (
            <div className="mb-8">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-2xl font-bold text-gray-900">«·⁄ﬁ«—«  «·√ﬂÀ— ÿ·»«</h2>
                </div>
          ...
          {filteredProperties.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">·«  ÊÃœ ⁄ﬁ«—« </h3>
              <p className="text-gray-600">Ã—¯»  €ÌÌ— «·›·« — √Ê «·»ÕÀ »ﬂ·„… √Œ—Ï</p>
            </div>
          ) : (
        ...
        <div className="relative h-56">
          ...
          {property.type && (
            <div className="absolute bottom-3 right-3 bg-black/60 backdrop-blur text-white px-3 py-1 rounded-lg text-sm font-medium">
              {property.type === 'apartment' ? '?? ‘ﬁ…' : 
               property.type === 'villa' ? '?? ›Ì·«' :
               property.type === 'land' ? '?? √—÷' :
               property.type === 'office' ? '??? „ﬂ »' : '?? „Õ·'}
            </div>
                    )}
                  </div>
