...
const BUILDING_AGES = [
  { value: 'under-construction', label: '��� �������' },
  { value: 'new', label: '���� (0-2 ���)' },
  { value: 'modern', label: '���� (3-10 �����)' },
  { value: 'old', label: '���� (10+ �����)' }
];
...
const AMENITIES = [
  ...
  // ������� ���������
  { id: 'pool', label: '����', icon: FaSwimmingPool, category: 'recreation' },
  { id: 'gym', label: '���� ������', icon: FaRunning, category: 'recreation' },
  { id: 'tennis', label: '���� ���', icon: FaGamepad, category: 'recreation' },
  { id: 'basketball', label: '���� ��� ���', icon: FaGamepad, category: 'recreation' },
  { id: 'football', label: '���� ��� ���', icon: FaGamepad, category: 'recreation' },
  ...
  { id: 'fire-safety', label: '���� �� �������', icon: FaFireExtinguisher, category: 'security' },
  { id: 'lock', label: '����� �����', icon: FaLock, category: 'security' },
  { id: 'key-card', label: '����� �����', icon: FaKey, category: 'security' },
  
  // �������
  { id: 'kitchen', label: '����', icon: FaUtensils, category: 'services' },
  { id: 'shopping', label: '����� ����', icon: FaShoppingCart, category: 'services' },
  { id: 'hospital', label: '������', icon: FaHospital, category: 'services' },
  { id: 'school', label: '�����', icon: FaGraduationCap, category: 'services' },
  { id: 'pharmacy', label: '������', icon: FaHospital, category: 'services' },
  
  // ������
  { id: 'ac', label: '�����', icon: FaSnowflake, category: 'comfort' },
  { id: 'heating', label: '�����', icon: FaSun, category: 'comfort' },
  ...
  { id: 'child-friendly', label: '����� �������', icon: FaChild, category: 'accessibility' },
  
  // ������� ��������
  { id: 'laundry', label: '����', icon: FaWater, category: 'utilities' },
  { id: 'storage', label: '����', icon: FaBox, category: 'utilities' },
  { id: 'water', label: '����', icon: FaWater, category: 'utilities' },
  { id: 'electricity', label: '������', icon: FaBolt, category: 'utilities' },
...
export default function AddNewProperty() {
  ...
  const generateDescription = (lang: 'ar' | 'en'): string => {
    const typeLabels = {
      'apartment': { ar: '���', en: 'Apartment' },
      'villa': { ar: '����', en: 'Villa' },
      'house': { ar: '����', en: 'House' },
      'office': { ar: '����', en: 'Office' },
      'shop': { ar: '���', en: 'Shop' },
      'warehouse': { ar: '������', en: 'Warehouse' },
      'land': { ar: '���', en: 'Land' },
      'building': { ar: '����', en: 'Building' }
    };

    const purposeLabels = {
      'sale': { ar: '�����', en: 'For Sale' },
      'rent': { ar: '�������', en: 'For Rent' },
      'investment': { ar: '���������', en: 'For Investment' }
    };

    const usageLabels = {
      'residential': { ar: '����', en: 'Residential' },
      'commercial': { ar: '�����', en: 'Commercial' },
      'mixed': { ar: '�����', en: 'Mixed' },
      'industrial': { ar: '�����', en: 'Industrial' },
      'tourism': { ar: '�����', en: 'Tourism' },
      'agricultural': { ar: '�����', en: 'Agricultural' }
    };

    const ageLabels = {
      'under-construction': { ar: '��� �������', en: 'Under Construction' },
      'new': { ar: '���� (0-2 ���)', en: 'New (0-2 years)' },
      'modern': { ar: '���� (3-10 �����)', en: 'Modern (3-10 years)' },
      'old': { ar: '���� (10+ �����)', en: 'Old (10+ years)' }
    };
    ...
    const baths = formData.baths ? `${formData.baths} ������` : '';
    ...
    if (lang === 'ar') {
      let description = `${type} ${usage} ${purpose} �� ${location}.`;
      
      if (area) description += ` �������: ${area}`;
      if (beds) description += `� ${beds}`;
      if (baths) description += `� ${baths}`;
      if (buildingAge) description += `. ��� ������: ${buildingAge}`;
      
      if (selectedAmenities.length > 0) {
        description += `. ����� ���: ${selectedAmenities.slice(0, 5).join('� ')}`;
        if (selectedAmenities.length > 5) {
          description += ` �${selectedAmenities.length - 5} ����� ����`;
        }
      }
      
      if (formData.buildingType === 'multi' && formData.totalUnits) {
        description += `. ���� ����� ������� ����� ��� ${formData.totalUnits} ����`;
      }
  ...
  const handlePrint = () => {
    ...
    Promise.all([
      ...
      const printContent = `
        ...
        <body>
          <div class="header">
            <h1>${formData.titleAr || '����� ������'}</h1>
            <h2 style="color: #4b5563; font-size: 18px; margin: 10px 0;">${formData.titleEn || ''}</h2>
            <p>��� ������: ${formData.referenceNo}</p>
            <p>����� �������: ${new Date().toLocaleDateString('ar', { calendar: 'gregory', numberingSystem: 'latn' })}</p>
            ${formData.surveyNumber ? `<p>��� ����� �������: ${formData.surveyNumber}</p>` : ''}
            ${formData.landNumber ? `<p>��� �����: ${formData.landNumber}</p>` : ''}
          </div>
          ...
          <div class="section">
            ...
            <div class="info-grid">
              ...
              <div class="info-item">
                <span class="info-label">��� ������:</span>
                <span class="info-value">${formData.buildingType === 'single' ? '���� ����' : '���� ����� �������'}</span>
              </div>
          ...
          <div class="section">
            ...
            <div style="margin-bottom: 15px;">
              <h3 style="color: #374151; font-size: 14px; margin-bottom: 8px;">����� ��������:</h3>
            ...
            <div class="images-grid">
              ${imageBase64s.map((imageBase64, index) => `
                <div class="image-item">
                  <InstantImage src="${imageBase64}" alt="���� ������ ${index + 1}"  loading="lazy" width={400} height={300}/>
                  ${index === formData.coverIndex ? '<div class="cover-badge">���� ������</div>' : ''}
                </div>
              `).join('')}
            </div>
          </div>
          ...
          <div class="section">
            ...
            <div class="info-grid">
              <div class="info-item">
                <span class="info-label">�����:</span>
                <span class="info-value">${formData.priceOMR ? formData.priceOMR + ' ���� �����' : '��� ����'}</span>
              </div>
              <div class="info-item">
                <span class="info-label">������� ������:</span>
                <span class="info-value">${formData.rentalPrice ? formData.rentalPrice + ' ���� �����' : '��� ����'}</span>
              </div>
            </div>
          </div>
          ...
          <div class="section units-section">
            ...
            ${formData.units.map((unit, unitIndex) => `
              <div class="unit-item">
                <div class="unit-header">������ ${unit.unitNo}</div>
                <div class="info-grid">
                  <div class="info-item">
                    <span class="info-label">��� ������:</span>
                  ...
                  <div class="info-item">
                    <span class="info-label">������� ������:</span>
                    <span class="info-value">${unit.rentalPrice} ���� �����</span>
                  </div>
                  <div class="info-item">
                    <span class="info-label">������:</span>
                    <span class="info-value">${unit.deposit} ���� �����</span>
                  </div>
                </div>
                ${unit.amenities && unit.amenities.length > 0 ? `
                <div style="margin-top: 10px;">
                  <h4 style="color: #374151; font-size: 12px; margin-bottom: 5px;">����� ������:</h4>
                  ...
                  <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 5px;">
                    ${unitImageBase64s[unitIndex].map((imageBase64, imgIndex) => `
                      <div style="text-align: center; border: 1px solid #e5e7eb; border-radius: 3px; padding: 3px;">
                        <InstantImage src="${imageBase64}" alt="���� ������ ${imgIndex + 1}" style="width: 100%; height: 50px; object-fit: cover; border-radius: 2px;"  loading="lazy" width={400} height={300}/>
                      </div>
                    `).join('')}
                  </div>
                </div>
            ...
            <div className="mb-8">
              ...
              <div className="flex justify-center mt-4">
                <div className="flex space-x-20">
                  {[
                    { step: 1, label: '��������� ��������', color: 'text-blue-600' },
                    { step: 2, label: '��� ������', color: 'text-green-600' },
                    { step: 3, label: '������ ���������', color: 'text-purple-600' },
                    { step: 4, label: '������� ��������', color: 'text-orange-600' },
                    { step: 5, label: '������� ��������', color: 'text-red-600' }
                        ...
                        return (
                          <div key={unitId} className="border border-gray-200 rounded-lg p-4">
                            <div className="flex justify-between items-center mb-4">
                              <h4 className="text-md font-semibold text-gray-800">������ {index + 1}</h4>
                              {index > 0 && (
                                <button
                                  type="button"
                                  onClick={() => {
                            ...
                            <div className="mt-4 border-t pt-4">
                              <h5 className="text-sm font-semibold text-gray-700 mb-3">��� ������ ������</h5>
