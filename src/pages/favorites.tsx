...
export default function FavoritesPage() {
  ...
  const getTypeText = (type: string) => {
    switch (type) {
      case 'property': return '⁄ﬁ«—';
      case 'auction': return '„“«œ';
      case 'customer': return '⁄„Ì·';
      case 'report': return ' ﬁ—Ì—';
      default: return type;
    }
  };
  ...
  const getStatusText = (status: string) => {
    switch (status) {
      case 'available': return '„ «Õ';
      case 'rented': return '„ƒÃ—';
      case 'reserved': return '„ÕÃÊ“';
      case 'live': return '„»«‘—';
      case 'upcoming': return 'ﬁ—Ì»«';
      case 'ended': return '«‰ ÂÏ';
      case 'active': return '‰‘ÿ';
      case 'inactive': return '€Ì— ‰‘ÿ';
              ...
              <div className="flex space-x-3 rtl:space-x-reverse">
                {selectedFavorites.length > 0 && (
                  ...
                  >
                    ...
                    Õ–› «·„Õœœ ({selectedFavorites.length})
                  </button>
                )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">«·»ÕÀ</label>
              ...
              <div>
                ...
                >
                  ...
                  <option value="property">⁄ﬁ«—« </option>
                  <option value="auction">„“«œ« </option>
                  <option value="customer">⁄„·«¡</option>
                  <option value="report"> ﬁ«—Ì—</option>
                </select>
              </div>
              
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2"> — Ì» Õ”»</label>
                <select
                  value={sortBy}
                  onChange={(e) => setSortBy(e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
                  <option value="addedAt"> «—ÌŒ «·≈÷«›…</option>
                  <option value="itemName">«”„ «·⁄‰’—</option>
                  <option value="itemPrice">«·”⁄—</option>
                </select>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center">
                ...
                <div className="mr-4">
                  <p className="text-sm font-medium text-gray-600">≈Ã„«·Ì «·„›÷·…</p>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center">
                ...
                <div className="mr-4">
                  <p className="text-sm font-medium text-gray-600">⁄ﬁ«—« </p>
              ...
              <div className="px-6 py-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2 rtl:space-x-reverse">
                    ...
                    />
                    <span className="text-sm text-gray-500"> ÕœÌœ «·ﬂ·</span>
                  </div>
                </div>
              </div>
                    ...
                    {sortedFavorites.map((favorite) => (
                      <tr key={favorite.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <div className="flex items-center space-x-2 rtl:space-x-reverse">
                            <button className="text-blue-600 hover:text-blue-900 p-1" title="⁄—÷">
                              <FiEye className="w-4 h-4" />
                            </button>
                            <button className="text-gray-400 hover:text-blue-500 p-1" title="„‘«—ﬂ…">
                              <FiShare2 className="w-4 h-4" />
                            </button>
                            <button
                              onClick={() => removeFavorite(favorite.id)}
          ...
          {sortedFavorites.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">·«  ÊÃœ ⁄‰«’— „›÷·…</h3>
              <p className="mt-1 text-sm text-gray-500">
                «»œ√ »≈÷«›… ⁄‰«’— ≈·Ï «·„›÷·… ·”ÂÊ·… «·Ê’Ê· ≈·ÌÂ« ·«Õﬁ«.
              </p>
            </div>
