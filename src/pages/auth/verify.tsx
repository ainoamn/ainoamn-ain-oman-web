...
function VerifyPage() {
  ...
  async function sendEmailCode() {
    if (!user?.email) return alert("·« ÌÊÃœ »—Ìœ ≈·ﬂ —Ê‰Ì „”Ã·");
    ...
    try {
      ...
      if (!r.ok) return alert(d?.error || "›‘· ≈—”«· «·ﬂÊœ");
      
      setEmailSent(true);
      if (d?.demoCode) console.log("Email Code:", d.demoCode);
      alert(" „ ≈—”«· ﬂÊœ «· Õﬁﬁ ≈·Ï »—Ìœﬂ «·≈·ﬂ —Ê‰Ì");
    } catch (error) {
      alert("ÕœÀ Œÿ√: " + (error as Error).message);
    } finally {
      setBusy(false);
    }
  }
  ...
  async function verifyEmailCode() {
    if (!emailCode) return alert("«·—Ã«¡ ≈œŒ«· «·ﬂÊœ");
    ...
    try {
      ...
      if (!r.ok) return alert(d?.error || "ﬂÊœ €Ì— ’ÕÌÕ");
  ...
  async function sendPhoneCode() {
    if (!user?.phone) return alert("·« ÌÊÃœ —ﬁ„ Â« › „”Ã·");
  ...
  async function verifyPhoneCode() {
    if (!phoneCode) return alert("«·—Ã«¡ ≈œŒ«· «·ﬂÊœ");
  ...
  function handleFileChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (!file.type.startsWith("image/")) {
      return alert("«·—Ã«¡ «Œ Ì«— ’Ê—…");
    }
    
    // «· Õﬁﬁ „‰ ÕÃ„ «·„·› (5MB max)
    if (file.size > 5 * 1024 * 1024) {
      return alert("ÕÃ„ «·„·› ÌÃ» √‰ ·« Ì Ã«Ê“ 5 „ÌÃ«»«Ì ");
    }
  ...
  async function uploadDocument() {
    if (!documentNumber) return alert("«·—Ã«¡ ≈œŒ«· —ﬁ„ «·ÊÀÌﬁ…");
    if (!documentFile) return alert("«·—Ã«¡ «Œ Ì«— ’Ê—… «·ÊÀÌﬁ…");
    ...
    try {
      ...
      if (!r.ok) return alert(d?.error || "›‘· —›⁄ «·ÊÀÌﬁ…");
      
      alert("?  „ —›⁄ «·ÊÀÌﬁ… »‰Ã«Õ! ”Ì „ „—«Ã⁄ Â« Œ·«· 24 ”«⁄…");
    ...
    <main dir={dir} className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 py-12 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2"> ÊÀÌﬁ Õ”«»ﬂ</h1>
          <p className="text-gray-600 text-lg">··Õ’Ê· ⁄·Ï «·„Ì“«  «·ﬂ«„·…° Ì—ÃÏ  ÊÀÌﬁ Õ”«»ﬂ</p>
        </div>
        ...
        <div className="bg-yellow-50 border-r-4 border-yellow-400 p-6 rounded-xl mb-8 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-yellow-800 mb-1">Õ”«»ﬂ €Ì— „ÊÀﬁ</h3>
              <p className="text-yellow-700 text-sm">
                Ì—ÃÏ  ÊÀÌﬁ Õ”«»ﬂ ··Ê’Ê· ≈·Ï Ã„Ì⁄ «·„Ì“«  Ê«·Œœ„« . «Œ — √Ì ÿ—Ìﬁ… „‰ «·ÿ—ﬁ «· «·Ì….
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900">«· Õﬁﬁ ⁄»— «·»—Ìœ «·≈·ﬂ —Ê‰Ì</h3>
                  </div>
                  <p className="text-gray-700">
                    ”Ì „ ≈—”«· ﬂÊœ  Õﬁﬁ „ﬂÊ‰ „‰ 6 √—ﬁ«„ ≈·Ï »—Ìœﬂ «·≈·ﬂ —Ê‰Ì:{" "}
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-6 border border-blue-200">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900">«· Õﬁﬁ ⁄»— —ﬁ„ «·Â« ›</h3>
                  </div>
                  <p className="text-gray-700">
                    ”Ì „ ≈—”«· ﬂÊœ  Õﬁﬁ „ﬂÊ‰ „‰ 6 √—ﬁ«„ ≈·Ï Â« ›ﬂ:{" "}
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900">«· Õﬁﬁ ⁄»— «·ÊÀ«∆ﬁ «·—”„Ì…</h3>
                  </div>
                  <p className="text-gray-700">
                    ﬁ„ » Õ„Ì· ’Ê—… Ê«÷Õ… „‰ ÊÀÌﬁ ﬂ «·—”„Ì…. ”Ì „ „—«Ã⁄ Â« Œ·«· 24 ”«⁄….
                  </p>
                </div>
                ...
                <div>
                  ...
                  >
                    <option value="national_id">«·»ÿ«ﬁ… «·‘Œ’Ì…</option>
                    <option value="passport">ÃÊ«“ «·”›—</option>
                    <option value="residence">«·≈ﬁ«„…</option>
                    <option value="driving_license">—Œ’… «·ﬁÌ«œ…</option>
                    <option value="commercial_register">«·”Ã· «· Ã«—Ì</option>
                  </select>
                </div>
                    ...
                    <label htmlFor="document-upload" className="cursor-pointer">
                      {documentPreview ? (
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 font-medium mb-1">«÷€ÿ ·«Œ Ì«— ’Ê—…</p>
                          <p className="text-sm text-gray-500">PNG, JPG Õ Ï 5MB</p>
                        </div>
                      )}
                    </label>
                  </div>
                ...
                <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600">
                  <p className="font-medium mb-2">?? ‰’«∆Õ ·’Ê—… √›÷·:</p>
                  <ul className="list-disc list-inside space-y-1 text-xs">
                    <li> √ﬂœ „‰ Ê÷ÊÕ Ã„Ì⁄ «· ›«’Ì· ›Ì «·’Ê—…</li>
                    <li> Ã‰» «·Ÿ·«· Ê«·«‰⁄ﬂ«”« </li>
                    <li>«· ﬁÿ «·’Ê—… ›Ì „ﬂ«‰ ÃÌœ «·≈÷«¡…</li>
                    <li> √ﬂœ „‰ ŸÂÊ— «·ÊÀÌﬁ… ﬂ«„·… ›Ì «·’Ê—…</li>
                  </ul>
                </div>
              </div>
            )}
        ...
        <div className="mt-8 text-center space-y-4">
          <p className="text-gray-600">
            ...
            >
              {(router.query.return as string) ? "«·⁄Êœ… ··’›Õ… «·”«»ﬁ…" : "«·«‰ ﬁ«· ≈·Ï «·œ«‘»Ê—œ"}
            </InstantLink>
          </p>
          <p className="text-sm text-gray-500">
            »⁄÷ «·„Ì“«  ﬁœ  ﬂÊ‰ „ÕœÊœ… Õ Ï Ì „  ÊÀÌﬁ Õ”«»ﬂ
          </p>
        </div>
      </div>
    </main>
