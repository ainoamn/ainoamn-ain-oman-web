              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-yellow-800">
                    إعداد مطلوب للذكاء الاصطناعي
                  </h3>
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>للاستفادة من ميزات الترجمة والتحسين التلقائي، يرجى:</p>
                    <ol className="list-decimal list-inside mt-2 space-y-1">
                      <li>الحصول على API key من <a href="https://makersuite.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="underline">Google AI Studio</a></li>
                      <li>إضافة المفتاح إلى ملف <code className="bg-yellow-100 px-1 rounded">.env.local</code></li>
                      <li>إعادة تشغيل السيرفر</li>
                    </ol>
                    <p className="mt-2 text-xs">
                      راجع ملف <code className="bg-yellow-100 px-1 rounded">AI_SETUP_INSTRUCTIONS.md</code> للتفاصيل الكاملة
                    </p>
                  </div>
                </div>
              </div>
