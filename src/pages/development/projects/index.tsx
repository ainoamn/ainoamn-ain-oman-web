  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <div className="flex items-center justify-between">
        ...
        <Link href="/admin/development/projects/new" className="px-4 py-2 rounded-xl border">+ مشروع جديد (إدارة)</Link>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
        {items.map((it) => (
          <Link key={it.id} href={`/development/projects/${it.id}`} className="rounded-2xl border p-5 hover:shadow-sm transition block">
