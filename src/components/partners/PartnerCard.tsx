  ...
  return (
    <div className="rounded-2xl border p-4 shadow-sm">
      <div className="flex items-center gap-3">
        {partner?.logo ? <InstantImage src={partner.logo} className="w-12 h-12 rounded-full" alt=""  loading="lazy" width={48} height={48}/> : <div className="w-12 h-12 rounded-full bg-slate-200" />}
        <div>
